---
title: "XGBoost Example 1"
author: "Rupert Thomas"
date: "Saturday, January 23, 2016"
output: html_document
---

Simple example using the XGBoost library for Extreme Gradient Boosting decision trees. This example shows how to setup the XGBoost model, although does no cross-validation (CV) so is vulnerable to over-fitting. See example 2 for how to do CV.
...
xgb <- xgboost(data = X_train, params=params2, label = y,
 nround=25, missing = "NA", prediction=TRUE)  #, verbose=FALSE)
